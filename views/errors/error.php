...
$errorMessage = isset($_GET['message']) ? htmlspecialchars($_GET['message']) : 'An unexpected error occurred. Please try again or return to the homepage.';
